            ...
            <Link href="/" className="inline-block mb-6 relative group">
              ...
              <div className="relative flex items-center">
                <Image
                  ...
                  width={120}
                  height={40}
                  className="w-auto h-10 object-contain relative z-10 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)] group-hover:drop-shadow-[0_0_20px_rgba(255,255,255,0.3)] transition-all duration-500"
                />
              </div>
            </Link>
